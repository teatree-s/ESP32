...
## 1.1. GMT130-V1.0 1.3 inch IPS 240x240

| ドライバ ST7789                                | ドライバ ST7789VW                                       |
| ---------------------------------------------- | ------------------------------------------------------- |
| <img src="./docs/GMT130-V1.0.jpg" width="180"> | <img src="./docs/GMT130-V1.0-ST7789VW.jpg" width="180"> |

ST7789VW の場合は、以下を「SPI_MODE3」としてください。
